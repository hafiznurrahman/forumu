  ...
  return (
    <div className="w-full h-auto bg-gray-900 rounded-lg p-2">
      <textarea
        ...
        className="flex w-full bg-transparent text-gray-50 outline-none resize-none placeholder:text-gray-500 placeholder:capitalize overflow-auto scrollHidden"
        rows="1"
